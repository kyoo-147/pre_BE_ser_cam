...
# khởi tạo các biến cần thiết là lòad model knn
...
# Gọi các giá trj cho model pose
with mp_pose.Pose(
    ...
    while cap.isOpened():
        ...
        if not success:
            ...
            continue
        # Tạo các biến xử lí cho hình ảnh được camera đưa vào
        image.flags.writeable = False
        image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
        results = pose.process(image)
        #khởi tạo bằng việc tính toán kết quả của landmark
        if results.pose_landmarks:
            # tính toán các giá trị và tọa độ của các trục x,y,z
            ...
            # dựa vào tọa độ point của pose_knn và suy luận    
        ...
        # Cho phép vẽ các điểm landmark lên image
